...
import com.example.myapplication.viewmodel.service;
...
public class serviceActivity extends AppCompatActivity {
        ...
        if (requestCode == COUNTER_SERVICE) {
            switch (resultCode) {
                ...
                case COUNTER_ANSWER:
                    ...
                    String message = getResources().getString(R.string.subtract, counter);
    ...
    private void writeToFile(String message) {
        FileProcessor.saveToFile(getString(R.string.log_file),message);
    }
}
